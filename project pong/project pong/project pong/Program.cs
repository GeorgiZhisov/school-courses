...
class Program
{
    static void Main(string[] args)
    {
        ...
        Racket left = new(5, 1);
        Racket right = new(5, field.GetCols - 2);
        Ball ball = new(field.GetRows / 2, field.GetCols / 2);
...
public class Racket
{
    ...
    {
        if (field.Get(_x - 1, this._y) == field.Tile)
        {
            return;
        }
    ...
    {
        if(field.Get(this._x + this._lenght, this._y) == field.Tile)
        {
            return;
        }
